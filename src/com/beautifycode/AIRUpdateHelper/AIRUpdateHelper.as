package com.beautifycode.AIRUpdateHelper {
	...
	public class AIRUpdateHelper {
		...
		public static function getAppInfo() : Object {
			...
			appInfoObj.version = appXml.ns::versionNumber[0];
		...
		private static function _confirmHandler(event : MouseEvent) : void {
			navigateToURL(new URLRequest(_downloadLocation));
			_cancelHandler(null);
			...
			// _downloadLoader.addEventListener(ProgressEvent.PROGRESS, _updateProgressHandler);
		}
